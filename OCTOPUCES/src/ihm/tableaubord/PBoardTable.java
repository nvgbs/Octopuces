...
public class PBoardTable extends JPanel {
	...
	public PBoardTable() {
		...
		btnNewButton_4.setFont(new Font("Helvetica", Font.BOLD, 14));
		...
		btnNewButton_5.setFont(new Font("Helvetica", Font.BOLD, 14));
		...
		btnNewButton_6.setFont(new Font("Helvetica", Font.BOLD, 14));
		...
		btnNewButton_7.setFont(new Font("Helvetica", Font.BOLD, 14));
		...
		btnNewButton_8.setFont(new Font("Helvetica", Font.BOLD, 14));
		btnNewButton_8.setBounds(16, 358, 263, 40);
		btnNewButton_8.setBorder(new LineBorder(new Color(70, 130, 180), 2));
		add(btnNewButton_8);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\JeSsyKa\\workspace\\IHMProjet\\img\\Icone_Utilisateurs_20x20.png"));
		lblNewLabel.setBounds(37, 399, 39, 40);
		add(lblNewLabel);
		...
		btnDeconnexion.setFont(new Font("Helvetica", Font.BOLD, 14));
